...
\begin{document}
  ...
  Given the inflexible nature of the SoC - being pre-selected as a fixed part of the design - forcing the SoC to behave according to the sensor output may come at significant software cost. In detail, the SoC is a collection of \acrfull{asic}
