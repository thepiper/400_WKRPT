...
\begin{document}
  ...
  \begin{footnote}
    \paragraph{A Note on Terminology and Linguistics}
    This particular project was done in an electrical engineering dominated environment, as such, the terminology used tends toward abbreviated units and electrical shorthand. They will be expanded and explained whenever possible.
  \end{footnote}
    ...
    There are two main types of electrical input to the system - signal and power. The power input is initially a single power supply source, and this does not change through the design process. The actual signal inputs (both signal profile, and upper and lower limits) were not well defined at the start of the project, and final values were reached through testing and analysis.

    \paragraph{}
    The operating voltage level of the EFM8BB1 family is 3.3V, thus the sensor circuitry must necessarily conform to this level. The absolute max There eventually arose a need for a separate 5V signal level due to the smoke sensor's digital circuit, resolving this will be touched upon in section \ref{sec:devel-electr-design}.
