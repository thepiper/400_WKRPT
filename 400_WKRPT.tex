...
\begin{document}
  ...
  This module's main purpose is to act as a safety mechanism guarding an appliance \footnote{An assembly that uses between 100 watts and 1000 watts of pwoer.} against failure - specifically over-current and fire. A paraphrased list of specified objectives are as follows:
  ...
  \subsection{\label{sec:integration}}
